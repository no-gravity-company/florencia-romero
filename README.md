...
- data/ - Global data accessible across the project. Fill out client.js before you begin.
...
Next, it is recommended to update `_data/client.js` with some new information about this project. Through the power of templating, the
